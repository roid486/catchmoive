...
@Controller
@RequestMapping("/mycupdate.com")
public class MycupdateContorller {
	...
	public ModelAndView cupdateok(CustomerVo cv, String c_email1, String c_email2,String c_pw2)
	{
		...
		ModelAndView mav = new ModelAndView("redirect:/mycupdate.com");
		mav.addObject("mtlist", dao.mtlist());
		int re = 0;
		...
		if(re != 1)
		{
			this.re=1;
			this.msg="정보를 확인하십시오.";
			mav.setViewName("redirect:/mycupdate.com");

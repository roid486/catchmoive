...
public class MovieVo {
	...
	public MovieVo(int rownum, int m_number, String m_name, String m_director, String m_actor, String m_nation,
			int m_runningtime, String m_grade, String m_genre, Date m_opendate, String m_synop, String m_image,
			String m_trailer, double m_score, String m_image1, String m_image2, String m_image3, int m_isshowing,
			int m_boxoffice) {
		super();
		this.rownum = rownum;

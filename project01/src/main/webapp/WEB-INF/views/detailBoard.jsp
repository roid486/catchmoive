...
<body>
	...
	<br> 내용:
	<br>
	<textarea rows="10" cols="60" readonly="readonly">${b.b_content }</textarea>
	<br>

	<img alt="" src="resources/jun/${b.b_fname }" width="100" height="100">
	<br> 첨부파일:${b.b_fname }(파일크기: ${b.b_fsize }) 등록일:${b.b_regdate }
	<br> ip:${b.b_ip }
	<br> 조회수:${b.b_hit }
	<br>
	<hr>
	...
	<c:if test="${sessionScope.se_id == b.c_id}">
		<a href="deleteBoard.com?b_number=${b.b_number }"><button
				type="button" id="btn_del">삭제</button></a>
		<a href="updateBoard.com?b_number=${b.b_number }"><button

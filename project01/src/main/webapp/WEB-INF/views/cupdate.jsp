			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control" id="pw"
						placeholder="8자리 이상 입력하십시오." name="c_pw" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control" id="pw2"
						placeholder="Password를 다시 입혁하십시오." name="c_pw2"
						required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="name"
						value="${cdetail.c_name }" name="c_name" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="date" class="form-control" id="age" name="c_age"
						value="${cdetail.c_age }" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="adrr" name="c_addr"
						value="${cdetail.c_addr }" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="tel"
						value="${cdetail.c_tel }" placeholder="전화번호를 '-'없이 입력하시오. "
						name="c_tel" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="email"
						value="${cdetail.c_email }" name="c_email2" required="required">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="gender2">Gender:
				</label>
				<div class="col-sm-10">
					<select class="form-control" id="gender2" name="c_gender"
						data-type="${cdetail.c_gender }">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="radio"
						value="yes" id="check2" name="c_check">예</label> <label
						class="checkbox-inline"><input type="radio" value="no"
						id="check2" name="c_check">아니오</label>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="echeck">Email 인증:
				</label>
				<div class="col-sm-10">

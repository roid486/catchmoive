 ...
 --%>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				...
				<a href="resources/upload/${m.m_image }" title="포스터 크게 보기 새창" target="_blank"> <img alt="${m.m_name } 새창" src="resources/upload/${m.m_image }" width="220" height="340" style="display: block;">포스터 크게 보기
				</a>
			</div>
			<div style="float: left;">
				...
				<label id="m_grade" style="visibility: hidden;">${m.m_grade }</label> <br> <label><b>감독 : ${m.m_director } / </b></label> <label><b>주연 배우 :${m.m_actor }</b></label><br> <label><b>장르 : ${m.m_genre }</b></label>&nbsp;&nbsp;/&nbsp;&nbsp;
				<label><b>기본 :&nbsp; ${m.m_grade },&nbsp; ${m.m_runningtime }분, &nbsp;${m.m_nation }</b></label><br> <label><b>개봉 :&nbsp; <f:formatDate value="${m.m_opendate }" pattern="yyyy/MM/dd"></f:formatDate>
				</b></label><br> <br>
	...
	<c:if test="${m.m_isshowing==1}">
		<div>
			...
			>>>>>>> branch 'master' of https://github.com/roid486/catchmoive.git <<<<<<< HEAD <br> <br> =======
			...
			<span>
				<form id="formId">
					<div class="form-group">
						<span class="" style="float: left;"> <input type="hidden" id="mnumber" name="ms_mid" value="${m.m_number }"> <input id="star" type="hidden" name="ms_score"> <input id="logId" type="hidden" name="ms_custid">
							...
							<button type="button" id="btn_register" class="btn btn-default btn-lg" style="height: 60px">
								<strong>등록</strong>
							</button></span>
					</div>
				</form>

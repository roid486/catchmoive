	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3">
				...
				<a href="resources/upload/${m.m_image }" title="포스터 크게 보기 새창"
					target="_blank"> <img alt="${m.m_name } 새창"
					src="resources/upload/${m.m_image }" width="220" height="340"
					style="display: block;">포스터 크게 보기
				</a>
			</div>
			<div style="float: left;">
				<div>
					<h3>
						<strong>${m.m_name }</strong>
					</h3>
					<label id="lab_showing">${m.m_isshowing }</label>
				</div>
				<label id="m_grade" style="visibility: hidden;">${m.m_grade }</label>
				<br> <label><b>감독 : ${m.m_director } / </b></label> <label><b>주연
						배우 :${m.m_actor }</b></label><br> <label><b>장르 : ${m.m_genre }</b></label>&nbsp;&nbsp;/&nbsp;&nbsp;
				<label><b>기본 :&nbsp; ${m.m_grade },&nbsp;
						${m.m_runningtime }분, &nbsp;${m.m_nation }</b></label><br> <label><b>개봉
						:&nbsp; <f:formatDate value="${m.m_opendate }"
							pattern="yyyy/MM/dd"></f:formatDate>
				</b></label><br> <br>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="resources/upload/${m.m_image1 }" alt="${m.m_image1 }"
							style="width: 100%; height: 500px;">
					</div>

					<div class="item">
						<img src="resources/upload/${m.m_image2 }" alt="${m.m_image2 }"
							style="width: 100%; height: 500px;">
					</div>

					<div class="item">
						<img src="resources/upload/${m.m_image3 }" alt="${m.m_image3 }"
							style="width: 100%; height: 500px;">
					</div>
				</div>
		...
		<div>
			...
			<iframe src="${m.m_trailer }" height="550" width="100%"
		...
		<div id="div_rating" style="float: left; width: 20%;">
			<div class="media-left media-top" style="float: left;">
				<img src="resources/images/user.png" class="media-object"
					style="width: 50px">
			</div>
		...
		<span>
			<form id="formId">
				<div class="form-group">
					<span class="" style="float: left;"> <input type="hidden"
						id="mnumber" name="ms_mid" value="${m.m_number }"> <input
						id="star" type="hidden" name="ms_score"> <input id="logId"
						type="hidden" name="ms_custid"> <textarea maxlength="100"
							class="form-control col-sm-4" rows="3" id="comment"
							name="ms_comment" placeholder="로그인한 회원만 이용 가능합니다."
							style="width: 580px;"></textarea>

						<button type="button" id="btn_register"
							class="btn btn-default btn-lg" style="height: 60px">
							<strong>등록</strong>
						</button></span>
				</div>
			</form>
		...
		<div id="reply">
			<!-- moviescore select 해올 부분 (댓글달린거 보여주려고) -->
			<div id="paste_no"></div>
		...
		<div class="modal fade" id="reviseModal" role="dialog">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="reviseForm">
							<div class="form-group">
								...
								<input type="hidden" id="revise_no" name="ms_no"> <img
									src="resources/images/user.png" width="30px" height="30px"
									style="float: left;">
								<div id="modal_rating" style="float: left; left: -20px"></div>
								<span id="span_rating" style="float: left;"></span>
								<div>
									<textarea maxlength="100" class="form-control col-sm-3"
										rows="3" id="revise_comment" name="ms_comment"
					...
					<div class="modal-footer">
						<center>
							<button id="btn_revise" type="button" class="btn btn-info">수정</button>
						</center>
					</div>
				</div>
			</div>

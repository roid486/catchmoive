			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="title"
						value="${edetail.e_title }" placeholder="이벤트제목을 입력하십시오."
						name="e_title" required="required">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" rows="5" id="comment"
						name="e_content" placeholder="이벤트내용을 입력하십시오." required="required">${edetail.e_content }</textarea>
				</div>
			</div>
			<div class="form-group">

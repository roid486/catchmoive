...
<body>
	...
	<div class="container" id="clist" style="width: 60%;">
		<h2>이벤트 목록</h2>
		<p>
			<a href="inserte.com"><button class="btn btn-primary">이벤트
					추가</button></a>
		</p>
		...
		<table class="table table-striped">
			...
			<tbody>
				<m:forEach var="el" items="${clist }">
					<tr>
						<td>${el.e_title }</td>
						<td><fm:formatDate value="${el.e_regdate }"
								pattern="yyyy/MM/dd" /></td>
						<td>${el.e_hit }</td>
						<td><a href="eupdate.com?e_number=${el.e_number }"><button
									class="btn btn-primary">수정</button></a></td>
						<td><a href="edelete.com?e_number=${el.e_number }"><button
									class="btn btn-primary">삭제</button></a></td>
					</tr>
				</m:forEach>
			</tbody>
		</table>

...
<body>
	...
	<div style="margin-left: 0%">
		...
		<div class="container">
			...
			<h1>
				<font style="color: #8CCBFB">공지사항 수정</font>
			</h1>
			<hr style="border: solid 1px #A1D6FE;">

			<form class="form-horizontal" action="updateNotice.com" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<input type="hidden" name="nb_fname" value="${b.b_fname }">
					<input type="hidden" name="nb_number" value="${n.nb_number }">

					<label class="control-label col-sm-2" for="email">제목:</label>
					<div class="col-sm-5">
						<input class="form-control" type="text" name="nb_title" value="${n.nb_title }">
						<br>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" rows="10" cols="60" name="nb_content">${n.nb_content }</textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<img class="form-control" alt="" src="resources/noticejun/${n.nb_fname }" width="100" height="100">
					</div>

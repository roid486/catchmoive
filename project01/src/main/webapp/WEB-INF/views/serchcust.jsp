			...
			<div class="container" style="width: 800px;">
			  <form class="form-horizontal" action="serchcust.com" method="post">
			    <div class="form-group">
			      ...
			      <div class="col-sm-10">
			        <input style="width: 50%;" type="text" class="form-control" id="name" placeholder="실명을 기입하시오." name="name">
			      </div>
			    </div>
			    <div class="form-group" style="width: 800px;">
	              <label class="control-label col-sm-2" for="email">Email:</label>
	              <div class="input-group">
	                <input type="text" class="form-control" id="email" placeholder="email을 입력하십시오." name="front_email">

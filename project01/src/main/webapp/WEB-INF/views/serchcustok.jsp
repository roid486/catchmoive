			...
			<div class="form-group">
				...
				<div class="input-group">
					<input type="text" class="form-control" id="id"
						placeholder="ID를 입력하십시오." name="id" value="${serchid }"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="name" value="${name }"
						readonly="readonly" name="c_name" required="required">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="tel"
						placeholder="전화번호를 '-'없이 입력하시오. " name="c_tel" required="required">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="email"
						value="${email }" readonly="readonly" name="c_email"
						required="required">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="checkbox"
						value="yes" id="check" name="c_check">예</label> <label
						class="checkbox-inline"><input type="checkbox" value="no"
						id="check" name="c_check">아니오</label>
				</div>
			</div>
			<div class="form-group">
